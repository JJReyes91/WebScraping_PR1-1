...
class OMIEdata():
    ...
    def __init__(self, start_date='2018-10-01', end_date='2018-10-02'):
        ...
        self._filename = 'data/OMIE_' + ''.join(start_date.split('-')) + '_' + ''.join(end_date.split('-')) + '.csv'
    ...
    def __getDataframe1(data):
        ...
        # Pasamos valores a numericos
        df = df.apply(pd.to_numeric, errors='coerce')
        
        # Definimos timestamp y la incluimos en index
    ...
    def __getDataframe2(data):
        ...
        # Extraemos la fecha y la ponemos como indice
        ...
        df.drop(df.columns[[0,3,4,7,8,11]], axis=1, inplace=True)
        
        # Formateamos correctamente los decimales
    ...
    def __execute(self):
        ...
        # iteramos apra obtener todos los dataframe
        self.df = lista[0]
        for dfr in lista[1:]:
